 ...
 * Keep aligned with `packages/agent-core/src/dsh/environment-copy.ts`.
 */

export const DSH_ENV_CHECK_ID = 'dsh-runtime' as const;
export const DSH_ENV_FIX_ACTION_ID = 'fix-dsh' as const;

/** Default npm pin shown in manual scripts (server may override via WORKMATE_DSH_NPM_VERSION). */
export const DSH_RUNTIME_NPM_VERSION_HINT = '0.1.1-rc.2';
...
export function buildDshRemediationPlan(
  ...
  npmVersion = DSH_RUNTIME_NPM_VERSION_HINT,
): DshRemediationPlan {
